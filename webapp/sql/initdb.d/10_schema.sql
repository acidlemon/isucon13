...
CREATE TABLE `users` (
  ...
  `icon_hash` VARCHAR(255) DEFAULT "d9f8294e9d895f81ce62e73dc7d5dff862a4fa40bd4e0fecf53f7526a8edcac0",
...
CREATE TABLE `livestream_tags` (
  ...
  INDEX `idx_livestream_tags_tag_id` (`tag_id`, `livestream_id` DESC),
...
CREATE TABLE `livecomments` (
  ...
  `created_at` BIGINT NOT NULL,
  INDEX `idx_livecomments_livestream_id` (`livestream_id`, `created_at` DESC)
) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
